...
public final class RelationshipWriter {
    ...
    private RelationshipWriter(DocxPackage pkg, Document relsDoc, int nextVariantNumber) {
        this.pkg = pkg;
